...
namespace RealTimeDataCapture2.util {
    ...
    class Constants  {
        ...
        public const string SIMBOLO_STOXX50 = "STOXX50";
        ...
        public const string DAO_TYPE_STOXX50_MARIADB = "STOXX50-MARIADB";
        ...
        public const String SQL_INSERT_TICK_STOXX50 = "INSERT INTO trading_db.ticks_stoxx50 " +
                                          "(tickdate, ticktime, tickmili, ope, trade_price, trade_vol, buy_price, sell_price) " +
                                          "VALUES " +
                                          "(@tickdate, @ticktime, @tickmili, @ope, @tprice, @tvol, @bprice, @sprice)";

        public const String SQL_INSERT_UPDATE_PRICES_STOXX50 = "INSERT INTO prices_stoxx50 " +
                                                                "VALUES(@tickdate, @ticktime, @tickmili, @bprice, @sprice) " +
                                                                "ON DUPLICATE KEY UPDATE " +
                                                                "ticktime=@ticktime, tickmili=@tickmili, buy_price=@bprice, sell_price=@sprice";
        ...
        public const String SQL_DELETE_TICKS_ALL_STOXX50 = "DELETE FROM trading_db.ticks_stoxx50";
